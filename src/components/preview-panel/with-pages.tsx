...
// Usamos forwardRef para permitir que o pai controle o scroll interno
  ...
  ({ className }, ref) => {
    ...
    return (
      <div className={cn('relative h-full w-full bg-slate-200/90 dark:bg-slate-950', className)}>
        ...
        {/* Viewport de Renderização - AQUI CONECTAMOS A REF */}
        <div
          ref={ref}
          className='absolute inset-0 flex flex-col items-center overflow-auto scroll-smooth px-8 py-12 print:overflow-visible print:p-0'>
          <div
            style={{
