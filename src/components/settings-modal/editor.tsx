  ...
  return (
    <TabsContent value='editor' className='mt-4 space-y-4'>
      ...
      <SettingsCard type='editor'>
        {editorShowOptions?.includes('theme') && (
          <>
            <SelectComponent
              data={[
            ...
            <div className='flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-100/50 px-3 py-2 dark:border-slate-800 dark:bg-slate-900/20'>
              ...
              <p className='text-xs text-slate-700 dark:text-slate-300'>
                Tema atual:{' '}
                <span className='font-semibold'>{getThemeLabel(config.editor.theme)}</span>
              </p>
            </div>
          </>
        )}
        ...
        {editorShowOptions?.includes('wordWrap') && (
            ...
            <Label htmlFor='word-wrap' className='flex cursor-pointer items-center gap-2'>
              ...
              <div>
                ...
                <p className='text-muted-foreground text-xs'>
                  Quebra de linha automática do código
                </p>
              </div>
            </Label>
            <Switch
        ...
        {editorShowOptions?.includes('minimap') && (
          <div className='mt-4 flex items-center justify-between space-y-2'>
        ...
        {/* Números de Linha */}
        {editorShowOptions?.includes('lineNumbers') && (
